...
function assert_not_empty() {
    ...
    if [[ -n "${actual}" ]]; then
        ...
        log_failure "${message}"
        log_error "  Expected not empty, but got empty"
        ((TESTS_FAILED++))
    fi
}
...
log_subheading "Test 1: Retrieves a value from the defaults file"
...
log_subheading "Test 2: Writes a retrieved default to the user settings"
if [[ "$(uname)" == "Darwin" ]]; then
...
log_subheading "Test 3: Sets and gets a new value"
...
log_subheading "Test 4: Updates an existing value"
...
log_subheading "Test 5: Returns an empty string for a non-existent key"
...
log_subheading "Test 8: Correctly handles values with special characters"
...
# Test 9: Correctly handles keys with special characters (Skipped)
log_subheading "Test 9: Correctly handles keys with special characters (Skipped)"
log_message "Skipping test for special characters in keys as per instructions."

# Test 10: Correctly handles values with equals signs
log_subheading "Test 10: Correctly handles values with equals signs"
...
# Test 11: Correctly handles keys with equals signs (Skipped)
log_subheading "Test 11: Correctly handles keys with equals signs (Skipped)"
log_message "Skipping test for equals signs in keys as per instructions."

# Test 12: Deleting a non-existent key does not affect other keys
log_subheading "Test 12: Deleting a non-existent key does not affect other keys"
...
# Test 13: Listing from an empty file returns nothing
log_subheading "Test 13: Listing from an empty file returns nothing"
...
# Test 14: Correctly handles values with newline characters
log_subheading "Test 14: Correctly handles values with newline characters"
...
# Test 15: Correctly handles intentionally quoted values
log_subheading "Test 15: Correctly handles intentionally quoted values"
...
# Test 16: Correctly handles values with leading/trailing whitespace
log_subheading "Test 16: Correctly handles values with leading/trailing whitespace"
